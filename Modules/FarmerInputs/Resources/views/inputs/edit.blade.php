...
@php
$title = 'Edit Input Distribution';
$subTitle = 'Edit Input Distribution';
@endphp
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            <h6 class="text-md text-primary-light mb-16">Edit Input Distribution Details</h6>
                            <br>
                            <form method="post" action="{{ route('farmer-inputs.update', $input->id) }}">
                                @csrf
                                <div class="mb-20">
                                    ...
                                    <select name="farmer_id" class="form-control radius-8" id="farmer_id">
                                        ...
                                        @foreach($farmers as $farmer)
                                            <option value="{{ $farmer->id }}" {{ old('farmer_id', $input->farmer_id) == $farmer->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-20">
                                    ...
                                    <select name="input_type_id" class="form-control radius-8" id="input_type_id">
                                        ...
                                        @foreach($inputTypes as $type)
                                            <option value="{{ $type->id }}" {{ old('input_type_id', $input->input_type_id) == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-20">
                                    ...
                                    <input name="quantity" type="number" class="form-control radius-8" id="quantity" placeholder="Enter quantity" value="{{ old('quantity', $input->quantity) }}">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input name="distributed_date" type="date" class="form-control radius-8" id="distributed_date" value="{{ old('distributed_date', $input->distributed_date) }}">
