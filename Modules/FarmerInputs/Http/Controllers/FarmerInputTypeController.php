...
class FarmerInputTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('farmerinputs::input-types.index', compact('inputTypes'));
    ...
    {
        return view('farmerinputs::input-types.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('farmerinputs::input-types.edit', compact('inputType'));
    }
