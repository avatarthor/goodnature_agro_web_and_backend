            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            <h6 class="text-md text-primary-light mb-16">Enter Input Type Details</h6>
                            <br>
                            <form method="post" action="{{ route('farmer-input-types.store') }}">
                                @csrf
                                <div class="mb-20">
                                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Name <span class="text-danger-600">*</span></label>
                                    <input name="name" type="text" class="form-control radius-8" id="name" placeholder="Enter input type name" value="{{ old('name') }}">
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea name="description" class="form-control radius-8" id="description" rows="3" placeholder="Enter input type description">{{ old('description') }}</textarea>
