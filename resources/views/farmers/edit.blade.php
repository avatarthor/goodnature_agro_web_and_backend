                ...
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            ...
                            <h6 class="text-md text-primary-light mb-16">Edit Farmer Details</h6>
                            ...
                            <form method="post" action="{{ route('farmers.update', $farmer->id) }}">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input name="name" type="text" class="form-control radius-8" id="name" value="{{ $farmer->name }}" placeholder="Enter Full Name">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input name="phone_number" type="number" class="form-control radius-8" id="phone_number" value="{{ $farmer->phone_number }}" placeholder="Enter Phone Number">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input name="location" type="text" class="form-control radius-8" id="location" value="{{ $farmer->location }}" placeholder="Enter Location">
