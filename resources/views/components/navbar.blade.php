                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-danger d-flex align-items-center gap-3" href="javascript:void(0)">
